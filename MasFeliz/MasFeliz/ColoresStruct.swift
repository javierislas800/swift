...
struct Colores {
    let colores = [UIColor(red: 210/255.0, green: 90/255, blue: 45/255, alpha: 1),
                   UIColor(red: 40/255.0, green: 170/255, blue: 45/255, alpha: 1),
                   UIColor(red: 3/255.0, green: 180/255, blue: 90/255, alpha: 1),
                   UIColor(red: 210/255.0, green: 190/255, blue: 5/255, alpha: 1),
                   UIColor(red: 120/255.0, green: 120/255, blue: 50/255, alpha: 1),
                   UIColor(red: 130/255.0, green: 80/255, blue: 90/255, alpha: 1),
                   UIColor(red: 130/255.0, green: 130/255, blue: 130/255, alpha: 1),
                   UIColor(red: 3/255.0, green: 50/255, blue: 90/255, alpha: 1)]
    
    func regresaColorAleatorio() -> UIColor {
        print("Colores.count=" + String(colores.count))
        var posicion = Int(arc4random_uniform(UInt32(colores.count)))
        //print("Posicion:" + String(posicion) + "\n")
        
        //if posicion > 7 || posicion < 0 {posicion = 7}
...
struct Datos {
    ...
    func regresaFraseFeliz() -> String {
        print("Frases.count=" + String(frases.count))
        let posicion = Int(arc4random_uniform(UInt32(frases.count)))
        //print("PosicionFrase:" + String(posicion) + "\n")
        //if posicion > 100 || posicion < 0 {posicion = 100}
